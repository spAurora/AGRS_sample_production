...
sr_image_path = r"E:\img_populus_GF7" #原始影像
point_shp = r"E:\project_populus_GF7\0-otherdata\populus_GF7_point240307_1.shp" #中心点point文件
out_path = r"E:\project_populus_GF7\1-clip_img" #输出目标文件夹
datasize = 1000 #输出的影像大小（像素）
img_type = '*.img' #原始影像类型 不可漏*.
output_prefix = 'populus_GF7_ori' #输出小块影像文件名的前缀
