...
point_shp = r"E:\xinjiang_huyang_hongliu\Huyang_test_0808\0-FL_test\0-point\real_haze_FL.shp" #中心点point文件
out_path = r"E:\xinjiang_huyang_hongliu\Huyang_test_0808\0-FL_test\real_haze_img" #输出目标文件夹
datasize = 256 #输出的影像大小（像素）
img_type = '*.dat' #原始影像类型 不可漏*.
output_prefix = 'FL_real_haze' #输出小块影像文件名的前缀
