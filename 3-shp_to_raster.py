...
image_path = r'E:\projict_UAV_yunnan\1-clip_img_neg' #存储样本影像的文件夹
line_path = r'E:\projict_UAV_yunnan\1-artificial_shp_neg' #存储人工勾画矢量的文件夹
save_path = r'E:\projict_UAV_yunnan\1-raster_label_neg' #输出的矢量转栅格样本文件夹
