...
traintxt_path = r'E:\GID_test\2-trainlist\trainlist_0702_small.txt' #输出栅格样本列表文件路径
image_path = r'E:\GID_test\image_small_enhance' #存储样本影像的文件夹路径
label_path = r'E:\GID_test\label_small_enhance' #存储栅格标签的文件夹路径
