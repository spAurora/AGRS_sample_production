...
traintxt_path = r'G:\Huyang_test_0808\2-trainlist\trainlist_0808_first.txt' #输出栅格样本列表文件路径
image_path = r'G:\Huyang_test_0808\2-enhance_img' #存储样本影像的文件夹路径
label_path = r'G:\Huyang_test_0808\2-enhance_label' #存储栅格标签的文件夹路径
