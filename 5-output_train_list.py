...
traintxt_path = r'E:\DOM\2-train_list\trainlist_240219.txt' #输出栅格样本列表文件路径
image_path = r'E:\DOM\2-enhanced_img' #存储样本影像的文件夹路径
label_path = r'E:\DOM\2-enhanced_label' #存储栅格标签的文件夹路径
